    ...
    <section id="solution" className="py-24 md:py-32 w-full flex flex-col items-center bg-transparent scroll-mt-24">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col gap-12 md:gap-24">
        ...
        <div className="w-full text-center mb-4 md:mb-10 mt-8">
          ...
          >
            Sua conta local com o poder de uma <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00D2FF] to-[#4CA1EF]">carteira global.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Toda a velocidade e segurança da tecnologia blockchain, mas invisível aos seus olhos. Você só interage com o que já conhece.
          </motion.p>
        </div>
        ...
        >
          <div className="w-full md:w-1/2 relative z-10">
            ...
            <p className="text-lg text-[#9BA4B5] leading-relaxed mb-8">
              Envie e receba pagamentos de e para qualquer lugar. Transformamos sua conta bancária local num passaporte financeiro global, rodando na rede Stellar. Sem intermediários, sem atrasos.
            </p>
          </div>
        ...
        >
          <div className="w-full md:w-1/2 relative z-10">
            ...
            <p className="text-lg text-[#9BA4B5] leading-relaxed">
              O WhatsApp e Telegram são nativos para você. Nossa Inteligência Artificial entende sua intenção em linguagem natural. Diga o que precisa pagar ou converter, e deixe a IA formular a transação perfeita pela rota mais barata.
            </p>
          </div>
            ...
            {/* Chat Bubble Mockup */}
             <div className="space-y-4 w-full px-6">
                ...
                <div className="bg-[#162032] border border-white/[0.03] rounded-2xl rounded-tl-sm p-4 max-w-[85%] text-sm text-slate-200 flex flex-col gap-2 shadow-[0_4px_24px_rgba(0,0,0,0.2)] shadow-[#00D2FF]/5">
                   ...
                   <button className="bg-[#4CA1EF] text-white font-medium py-2 rounded-lg mt-1 text-xs uppercase tracking-wider w-full">Confirmar Pix</button>
                </div>
             </div>
          </div>
        </motion.div>
