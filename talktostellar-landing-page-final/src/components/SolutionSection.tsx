    ...
    <section id="solution" className="py-24 md:py-32 w-full flex flex-col items-center bg-transparent scroll-mt-24">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col gap-12 md:gap-24">
        ...
        <div className="w-full text-center mb-4 md:mb-10 mt-8">
          ...
          >
            Sua conta local com o poder de uma <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E59E25] to-[#D48C1C]">carteira global.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Toda a eficiência e segurança da infraestrutura financeira moderna, totalmente invisível aos seus olhos. Você só interage com o aplicativo de mensagens que já sabe usar.
          </motion.p>
        </div>
        ...
        >
          <div className="w-full md:w-1/2 relative z-10">
            <div className="w-12 h-12 rounded-xl bg-[#E59E25]/10 flex items-center justify-center mb-6">
              <Globe className="text-[#E59E25] w-6 h-6" />
            </div>
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
              Seu dinheiro livre de fronteiras financeiras.
            </h3>
            <p className="text-lg text-[#9BA4B5] leading-relaxed mb-8">
              Envie e receba de qualquer lugar do mundo. Transformamos o seu Pix em um passaporte financeiro global rodando direto na Stellar Network. Menos intermediários, zero atrasos.
            </p>
          </div>
          <div className="w-full md:w-1/2 relative h-[300px] rounded-2xl overflow-hidden border border-white/[0.05] bg-[#121212]">
            ...
            <div className="absolute top-8 left-8 bg-[#121212] border border-white/[0.05] rounded-xl p-4 shadow-[0_4px_24px_rgba(0,0,0,0.2)] flex items-center gap-4">
               ...
               <div>
                  <p className="text-xs text-[#9BA4B5]">Maria enviou do exterior</p>
                  <p className="text-xl font-bold text-white">+ 225 USD</p>
               </div>
            </div>
            <div className="absolute bottom-8 right-8 bg-[#121212] border border-white/[0.05] rounded-xl p-4 shadow-[0_4px_24px_rgba(0,0,0,0.2)] flex items-center gap-4">
               <div>
                  <p className="text-xs text-[#9BA4B5]">Você recebeu em BRL</p>
                  <p className="text-xl font-bold text-[#E59E25]">+ R$ 1.125,00</p>
               </div>
        ...
        >
          <div className="w-full md:w-1/2 relative z-10">
            <div className="w-12 h-12 rounded-xl bg-[#D48C1C]/10 flex items-center justify-center mb-6">
              <MessageCircle className="text-[#D48C1C] w-6 h-6" />
            </div>
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
              Tudo por onde você já conversa.
            </h3>
            <p className="text-lg text-[#9BA4B5] leading-relaxed">
              WhatsApp e Telegram já fazem parte do seu dia. Nossa Inteligência Artificial entende a sua intenção em linguagem natural. Basta digitar o que você quer converter ou pagar, e nosso agente estrutura toda a operação financeira pela rota mais eficiente.
            </p>
          </div>
          <div className="w-full md:w-1/2 relative h-[300px] rounded-2xl overflow-hidden border border-white/[0.05] bg-[#121212] flex items-center justify-center">
            {/* Chat Bubble Mockup */}
             <div className="space-y-4 w-full px-6">
                ...
                <div className="bg-[#121212] border border-white/[0.05] rounded-2xl rounded-tl-sm p-4 max-w-[85%] text-sm text-slate-200 flex flex-col gap-2 shadow-[0_4px_24px_rgba(0,0,0,0.2)] shadow-[#E59E25]/5">
