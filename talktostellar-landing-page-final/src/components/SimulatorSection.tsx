    ...
    <section id="simulator" className="py-20 w-full flex flex-col items-center relative scroll-mt-24">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
          Simule sua <span className="text-[#E59E25]">economia</span>
        </h2>
          ...
          <div className="bg-white/5 border border-white/[0.05] rounded-2xl p-4">
            ...
            <div className="flex items-center justify-between">
              <input 
                ...
                value={usdcAmount}
                readOnly
                className="bg-transparent border-none outline-none text-3xl font-bold text-[#E59E25] w-full"
                placeholder="0.00"
              />
              <div className="flex items-center gap-2 bg-[#080808]/80 rounded-full px-3 py-1.5 shrink-0 ml-2 border border-white/[0.05]">
                <div className="w-5 h-5 rounded-full bg-[#D48C1C] flex items-center justify-center">
      ...
      <div className="w-full max-w-5xl mx-auto px-4 mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-[#080808] border border-[#E59E25]/30 rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_4px_32px_rgba(34,211,238,0.15)] relative transform md:-translate-y-4 z-10">
            ...
            <div className="w-16 h-16 rounded-full bg-[#E59E25]/10 flex items-center justify-center mb-4 border border-[#E59E25]/20">
              <span className="text-[#E59E25] font-bold text-2xl">✓</span>
            </div>
            <h5 className="text-white font-bold text-lg mb-1">TalkToStellar</h5>
            <p className="text-[#E59E25] text-sm font-medium mb-4">A melhor rota blockchain</p>
            <div className="mt-auto pt-4 border-t border-white/[0.05] w-full">
              <p className="text-[11px] text-[#E59E25]/70 uppercase tracking-wider mb-1">Taxas mínimas a partir de</p>
