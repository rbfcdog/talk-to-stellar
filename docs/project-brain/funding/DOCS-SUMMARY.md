...
|------|-------|-------|---------|---------------|
| [`GRANTS.md`](./GRANTS.md) | GRANTS.md — Funding & Deliverables | 604 | **SOW**: `docs/funding/sow/SOW_instawards_submission_brl_usd_rail_20260520.md` **Scope**: PIX-to-Stellar transfer lifecycle engine, payout routing, reconciliation; D2 foundation package ready, and D3 Week 4 evidence-label files assembled with Mermaid architecture diagrams. | English or mostly English. |
