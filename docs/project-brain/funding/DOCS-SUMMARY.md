...
|------|-------|-------|---------|---------------|
| [`GRANTS.md`](./GRANTS.md) | GRANTS.md — Funding & Deliverables | 430 | **SOW**: `docs/funding/sow/SOW_instawards_submission_brl_usd_rail_20260520.md` **Scope**: PIX-to-Stellar transfer lifecycle engine, payout routing, reconciliation | English or mostly English. |
