...
- **Features**: PIX virtual accounts, ACH off-ramp, webhook for deposit confirmation; payout adapter currently remains compatibility-oriented while provider access is pending
- **Failure modes**: Virtual account setup failures, webhook signature validation
