...
| [`key-integrations.md`](./key-integrations.md) | Key Integrations Page — Surface Audit | 680 | Compact end-to-end test panel for Abroad Finance, Reflector, StellarExpert fraud screening, and Soroswap. Documents the same-origin `/api/[...path]` proxy path, backend route map, fixed #53 watcher/proxy failure, fixed #54 Soroswap quote fallback, fixed #56 Freighter sign/submit flow, and fixed #57 stream-rate-limit handling. | English or mostly English. |
