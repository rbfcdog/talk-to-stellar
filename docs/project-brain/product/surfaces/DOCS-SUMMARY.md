...
| [`key-integrations.md`](./key-integrations.md) | Key Integrations Page — Surface Audit | 660 | Compact end-to-end test panel for Abroad Finance, Reflector, StellarExpert fraud screening, and Soroswap. Documents the same-origin `/api/[...path]` proxy path, backend route map, fixed #53 watcher/proxy failure, and fixed #54 Soroswap quote fallback. | English or mostly English. |
