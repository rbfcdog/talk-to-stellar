...
Muitos arquivos `docs/` e `docs/funding/sow/` mencionam mock/sandbox porque explicam o estado atual, demo e planos.
...
- `docs/settlement/BRL_USD_STELLAR_WISE_BUILD_LOG.md`
...
- `docs/research/PROJECT_FEATURE_STATE_FOR_AI_REVIEW_20260523.md`
...
- `docs/funding/sow/SOW_brl_stellar_usd_bank_payout_20260519.md`
- `docs/funding/sow/SOW_instawards_submission_brl_usd_rail_20260520.md`
- `docs/funding/sow/SOW_current_project_state_20260519.md`
...
- `deprecated/docs/twilio-webhook/README.md`
...
- `docs/settlement/BRL_USD_STELLAR_WISE_BUILD_LOG.md`
- `docs/settlement/BRL_USD_STELLAR_WISE_FEES_AND_ANCHOR_FLOW.md`
- `docs/settlement/BRL_USD_STELLAR_WISE_IMPLEMENTATION_PLAN.md`
- `docs/CUSTODIAL.md`
- `docs/ENV_AND_MIGRATIONS_GUIDE_20260519.md`
- `docs/ETHERFUSE_PIX_KYC_FLOW.md`
- `docs/funding/INSTAWARDS_SOW.md`
- `docs/INSTITUTION_SETTLEMENT_INTERFACE_GUIDE.md`
...
- `docs/funding/sow/SOW_brl_stellar_usd_bank_payout_20260519.md`
- `docs/funding/sow/SOW_current_project_state_20260519.md`
- `docs/funding/sow/SOW_inital.md`
- `docs/funding/sow/SOW_instawards_submission_brl_usd_rail_20260520.md`
