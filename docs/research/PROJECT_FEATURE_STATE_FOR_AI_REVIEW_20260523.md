...
- `docs/funding/sow/`: Statement of Work e propostas.
...
| Docs/SOW | `docs/`, `docs/funding/sow/` | Muito completo, incluindo video guide, security, UX, fee system, deployment e SOW. |
...
- `backend/migrations/20260613_00_full_schema.sql`: schema completo, preparacao Mainnet, hardening, rail internacional, carteiras Mainnet, dedupe e lifecycle D1.

Observacao:

- Runtime startup migrations foram removidas; o schema vem somente de `backend/migrations/20260613_00_full_schema.sql`.
- O projeto espera a migration consolidada aplicada manualmente em Supabase/DB ou via `npm run migrate:required`.
- RLS e policies existem na migration consolidada, mas devem ser verificadas no banco real.
...
- `docs/security/SECURITY_FULL_CODEBASE_SCAN_20260519.md`
- `docs/security/SECURITY_FIX_BATCH_20260519.md`
- `docs/security/SECURITY_HARDENING_IMPLEMENTATION_20260519.md`
- `docs/PASSKEY_ENROLLMENT_SECURITY_FIX.md`
- `docs/security/SECURITY_AUDIT_CHALLENGE_1.md`
...
- `docs/business/PROJECT_BUSINESS_DESCRIPTION.md`
- `docs/architecture/PROJECT_TECHNICAL_DESCRIPTION.md`
- `docs/funding/sow/SOW_instawards_submission_brl_usd_rail_20260520.md`

UX:

- `docs/USER_DEMO_GUIDE.md`
- `docs/product/UX_FULL_CODEBASE_SCAN_20260521.md`
- `docs/product/UX_FEE_REDUCTION_UPGRADE_MAP.md`
...
- `docs/settlement/BRL_USD_INTERNATIONAL_ACCOUNT_DELIVERY.md`
- `docs/INSTITUTION_SETTLEMENT_INTERFACE_GUIDE.md`
- `docs/settlement/BRL_USD_RAIL_OPERATOR_RUNBOOK.md`
- `docs/settlement/BRL_USD_STELLAR_WISE_TECHNICAL_DESIGN.md`
- `docs/settlement/BRL_USD_STELLAR_WISE_FEES_AND_ANCHOR_FLOW.md`
- `docs/SISTEMA_DE_TAXAS_ATUAL.md`

Mainnet:

- `docs/stellar/STELLAR_MAINNET_INFRASTRUCTURE.md`
- `docs/stellar/STELLAR_MAINNET_USER_WALLET_CONSOLE.md`
- `docs/stellar/STELLAR_MAINNET_HARDENING_SCAN.md`
...
- Reviewer deve avaliar o produto atual olhando `backend/`, `frontend/`, `telegram/`, `evolution/`, `docs/` e `docs/funding/sow/`, nao o legado.
