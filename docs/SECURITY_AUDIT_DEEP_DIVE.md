...
- `backend/src/migrations/agent.migration.ts:8-30` cria `public.exec_sql(sql TEXT)`.
- `backend/src/migrations/agent.migration.ts:12` define `SECURITY DEFINER`.
- `backend/src/migrations/agent.migration.ts:21-26` executa dinamicamente o SQL recebido por parametro.
...
- `backend/src/migrations/agent.migration.ts:255-282` cria `store_private_key` e `get_private_key`.
- `backend/src/migrations/agent.migration.ts:266` e `:275` usam `SECURITY DEFINER`.
- `backend/src/migrations/agent.migration.ts:278-280` faz `SELECT decrypted_secret FROM vault.decrypted_secrets WHERE id = secret_id`.
...
- `backend/src/migrations/agent.migration.ts:8-30` - cria `exec_sql`.
- `backend/src/migrations/agent.migration.ts:255-282` - cria funcoes de Vault.
- `backend/src/migrations/agent.migration.ts:629-648` - desabilita RLS em tabelas sensiveis.
