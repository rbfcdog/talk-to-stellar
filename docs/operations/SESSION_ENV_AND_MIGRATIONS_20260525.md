...
2. Aplicar a migration consolidada no Supabase/Postgres.
...
Para banco novo, `backend/migrations/20260613_00_full_schema.sql` ja inclui essas colunas e todo o restante do schema atual. Nao existem migrations cronologicamente posteriores no repositorio.
...
A migration consolidada tambem inclui contas externas/PIX, o rail BRL -> USDC -> USD e a idempotencia dos logs de operacao.
