...
Generated summary for `docs/insta-awards/deliverables/deliverable-2`. Last generated: 2026-06-16.
...
| [`README.md`](./README.md) | Deliverable 2 — USD Delivery & Payout Coordination Layer | 705 | Active D2 package entry point covering all four requested reviewer labels, current Circle readiness, completed sandbox payout status, current database boundary, D1 cross-reference, and D3 follow-up work. | English or mostly English. |
| [`STATUS.md`](./STATUS.md) | Deliverable 2 Status — USD Delivery & Payout Coordination Layer | 435 | One-page current status: all four D2 evidence labels have files, Circle sandbox payout status was observed completed through protected polling, and webhook/video follow-up boundaries are listed. | English or mostly English. |
...
| [`runs/`](./runs/) | 5 | [`DOCS-SUMMARY.md`](./runs/DOCS-SUMMARY.md) |
