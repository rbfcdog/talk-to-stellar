...
| [`2026-06-14-2259-real-stellar-json-evidence.md`](./2026-06-14-2259-real-stellar-json-evidence.md) | Run 2026-06-14-2259 - Real Stellar JSON Evidence | 298 | Added two Stellar JSON evidence files from `payment_logs.id = 2`, verified on Horizon testnet ledger `2488252`, while keeping final D1 PIX-to-payout evidence marked pending. | English or mostly English. |
| [`2026-06-15-1402-stellar-evidence-label-cleanup.md`](./2026-06-15-1402-stellar-evidence-label-cleanup.md) | Run 2026-06-15-1402 - Stellar Evidence Label Cleanup | 293 | Renamed the active Stellar payment JSON files to neutral transaction references, preserved DB/Horizon provenance, and updated D1/D2/grant references. | English or mostly English. |
