...
- Migration preparatoria em `backend/migrations/20260613_00_full_schema.sql`.
...
- A preparacao de schema agora faz parte da migration consolidada executada por `migrate:required`.
...
Ou cole o SQL no editor do Supabase. A migration prepara os metadados, mas nao
ativa o cutover de Mainnet no runtime.
