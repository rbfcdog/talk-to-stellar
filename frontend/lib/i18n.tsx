...
const englishDictionary: Dictionary = {
    ...
    welcome_select:
      'Select TalkToStellar in the sidebar. Start with: 1) "balance", 2) "deposit 150 reais with PIX", 3) "convert 500 reais to dollars", 4) "keep 200 dollars earning".',
...
const portugueseDictionary: Dictionary = {
    ...
    welcome_select:
      'Selecione TalkToStellar na lateral. Comece com: 1) "saldo", 2) "colocar 150 reais com PIX", 3) "converter 500 reais para dólares", 4) "deixar 200 dólares rendendo".',
