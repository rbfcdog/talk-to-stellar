...
const englishDictionary: Dictionary = {
    ...
    login_passkey_card_body: "Use biometrics or your device lock when a Passkey is registered.",
    ...
    login_passkey_submit: "Sign in with Passkey",
...
const portugueseDictionary: Dictionary = {
    ...
    login_passkey_card_title: "Passkey",
    login_passkey_card_body: "Use biometria ou bloqueio do aparelho quando houver uma Passkey cadastrada.",
    ...
    login_passkey_submit: "Entrar com Passkey",
