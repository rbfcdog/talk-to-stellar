...
const englishDictionary: Dictionary = {
    ...
    chat_sidebar_preview: "Hi. I can help with balance, PIX, conversion, yield, and money out.",
    ...
    chat_link_yield: "Open yield screen",
    ...
    login_subtitle:
      "Sign in to continue where you left off. Next after login: balance, PIX money in/out, conversions, yield, and payments.",
    ...
    login_next_card_body: "Go back to the chat and ask for balance, PIX, conversion, yield, or money out.",
    ...
    hero_title_2: "Money In. Yield. Out.",
    hero_subtitle:
    ...
    hero_card_1_body: "Ask for balance, PIX, payment, conversion, yield, or withdrawal without downloading a new app.",
...
const portugueseDictionary: Dictionary = {
    ...
    chat_sidebar_preview: "Oi. Posso ajudar com saldo, PIX, conversão, rendimento e saída.",
    chat_input_placeholder: "Digite: converter 500 reais para euros, deixar dólares rendendo ou retirar para PIX",
    ...
    chat_link_yield: "Abrir tela de rendimento",
    ...
    welcome_select:
      'Selecione TalkToStellar na lateral. Comece com: 1) "saldo", 2) "colocar 150 reais com PIX", 3) "converter 500 reais para euros", 4) "deixar 200 dólares rendendo", 5) "entrar, render e sair para PIX".',
    welcome_protected: "Suas conversas ficam protegidas enquanto você usa sua conta.",
    login_title: "Entre na sua conta",
    login_subtitle:
      "Entre para continuar de onde parou. Depois do login: saldo, PIX entrando/saindo, conversões, rendimento e pagamentos.",
    ...
    login_next_card_body: "Volte ao chat e peça saldo, PIX, conversão, rendimento ou saída.",
    ...
    hero_title_1: "TalkToStellar.",
    hero_title_2: "PIX. Rendimento. Saída.",
    hero_subtitle:
      "Uma conta conversacional para colocar, converter, deixar rendendo e retirar dinheiro pelos canais que a pessoa já usa todos os dias.",
    hero_card_1_title: "Comece pelo chat",
    hero_card_1_body: "Peça saldo, PIX, pagamento, conversão, rendimento ou retirada sem baixar um novo app.",
