...
const englishDictionary: Dictionary = {
    ...
    chat_agent_welcome:
      "Hi, this is TalkToStellar.\n\nI can help with balance, PIX, contacts, payments, conversions, review and the full money cycle.\n\nExamples:\n1. balance\n2. add 10 reais with PIX\n3. convert 500 reais to euros\n4. review 200 dollars\n5. add, review, and withdraw to PIX\n\nIf you are not signed in yet, send “login” and I will create a secure access link.",
    chat_search_placeholder: "Search account contacts...",
    chat_sidebar_preview: "Hi. I can help with balance, PIX, conversion, review, and money out.",
    chat_input_placeholder: "Type: convert 500 reais to euros, review dollars, or withdraw to PIX",
    ...
    welcome_select:
      'Select TalkToStellar in the sidebar. Start with: 1) "balance", 2) "deposit 150 reais with PIX", 3) "convert 500 reais to euros", 4) "review 200 dollars", 5) "add, review, and withdraw to PIX".',
    welcome_protected: "Your conversations stay protected while you use your account.",
    login_title: "Sign in to your account",
    login_subtitle:
      "Sign in to continue where you left off. Next after login: balance, PIX money in/out, conversions, review, and payments.",
    ...
    login_next_card_body: "Go back to the chat and ask for balance, PIX, conversion, review, or money out.",
    ...
    hero_subtitle:
      "A conversational account for adding, converting, reviewing, and withdrawing through the channels people already use every day.",
    hero_card_1_title: "Start from chat",
    hero_card_1_body: "Ask for balance, PIX, payment, conversion, review, or withdrawal without downloading a new app.",
...
const portugueseDictionary: Dictionary = {
    ...
    chat_agent_welcome:
      "Olá, aqui é o TalkToStellar.\n\nPosso ajudar com saldo, PIX, contatos, pagamentos, conversões, revisão e ciclo completo do dinheiro.\n\nExemplos:\n1. saldo\n2. colocar 10 reais via PIX\n3. converter 500 reais para euros\n4. revisar 200 dólares\n5. entrar, revisar e sair para PIX\n\nSe ainda não entrou, mande “login” e eu gero um link seguro de acesso.",
    chat_search_placeholder: "Buscar contatos da conta...",
    chat_sidebar_preview: "Oi. Posso ajudar com saldo, PIX, conversão, revisão e saída.",
    chat_input_placeholder: "Digite: converter 500 reais para euros, revisar dólares ou retirar para PIX",
    ...
    welcome_select:
      'Selecione TalkToStellar na lateral. Comece com: 1) "saldo", 2) "colocar 150 reais com PIX", 3) "converter 500 reais para euros", 4) "revisar 200 dólares", 5) "entrar, revisar e sair para PIX".',
    welcome_protected: "Suas conversas ficam protegidas enquanto você usa sua conta.",
    login_title: "Entre na sua conta",
    login_subtitle:
      "Entre para continuar de onde parou. Depois do login: saldo, PIX entrando/saindo, conversões, revisão e pagamentos.",
    ...
    login_next_card_body: "Volte ao chat e peça saldo, PIX, conversão, revisão ou saída.",
    ...
    hero_subtitle:
      "Uma conta conversacional para colocar, converter, revisar e retirar dinheiro pelos canais que a pessoa já usa todos os dias.",
    hero_card_1_title: "Comece pelo chat",
    hero_card_1_body: "Peça saldo, PIX, pagamento, conversão, revisão ou retirada sem baixar um novo app.",
