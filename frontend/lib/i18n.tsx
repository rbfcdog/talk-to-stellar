...
const englishDictionary: Dictionary = {
    ...
    login_pin_card_title: "Password",
    login_pin_card_body: "Use your password to sign in. Older accounts can still use the PIN as the first password.",
    ...
    login_pin_only_title: "Password required",
    login_pin_only_help: "This {{provider}} is already linked. Enter your password to continue. Older accounts can use the PIN.",
    login_email: "Email",
    login_pin: "Password",
    login_pin_placeholder: "Enter your password",
    login_forgot_pin: "Forgot password or PIN?",
    login_forgot_pin_sending: "Sending...",
    login_forgot_pin_sent: "If the account exists, we sent the password and PIN setup link by email.",
    login_forgot_pin_need_email: "Enter your email first so we can send the password and PIN setup link.",
    login_forgot_pin_error: "Could not send the password and PIN setup email right now.",
    login_submit: "1) Sign in with password",
...
const portugueseDictionary: Dictionary = {
    ...
    login_pin_card_title: "Senha",
    login_pin_card_body: "Use sua senha para entrar. Contas antigas ainda podem usar o PIN como primeira senha.",
    ...
    login_pin_only_title: "Senha necessária",
    login_pin_only_help: "Este {{provider}} já está vinculado. Digite sua senha para continuar. Contas antigas podem usar o PIN.",
    login_email: "E-mail",
    login_pin: "Senha",
    login_pin_placeholder: "Digite sua senha",
    login_forgot_pin: "Esqueci senha ou PIN",
    login_forgot_pin_sending: "Enviando...",
    login_forgot_pin_sent: "Se a conta existir, enviamos o link de configuração de senha e PIN por e-mail.",
    login_forgot_pin_need_email: "Informe seu e-mail primeiro para enviarmos o link de configuração de senha e PIN.",
    login_forgot_pin_error: "Não consegui enviar o e-mail de configuração de senha e PIN agora.",
    login_submit: "1) Entrar com senha",
