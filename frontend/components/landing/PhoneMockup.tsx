      ...
      >
          ...
          {step >= 1 && (
            ...
            >
              <p className="text-[15px] leading-snug">
                ...
                {L(". Peça contatos, saldo, PIX, conversão, aplicação ou saída para seu PIX. Se precisar entrar, eu gero um link seguro.", ". Ask for contacts, balance, PIX, conversion, application, or money out to your PIX. If you need to sign in, I create a secure link.")}
              </p>
        ...
        <AnimatePresence>
          {step >= 2 && (
            ...
            >
              <p className="text-[15px] leading-snug">
                {L("Quero colocar R$ 500, aplicar e depois sair para meu PIX.", "I want to add R$500, apply it, then withdraw to my PIX.")}
              </p>
        ...
        <AnimatePresence>
          {step >= 3 && (
            ...
            >
              <p className="text-[15px] leading-snug">
                {L("Perfeito. Preparei a confirmação para ", "Done. I prepared the confirmation for ")}
                <strong className="text-[#00D2FF]">R$ 500,00</strong>
                . <br/>
                {L("Etapas: PIX, aplicação e retirada", "Steps: PIX, application, and withdrawal")}
                . <br/><br/>
                {L("Vou abrir um link para conferir e confirmar com PIN.", "I will open a link to check and confirm with PIN.")}
              </p>
