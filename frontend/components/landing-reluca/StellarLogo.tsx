export function StellarLogo({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M14.348 10.052L4.174 14.881L2.943 12.28L13.117 7.451L14.348 10.052Z" fill="currentColor"/>
      <path d="M21.057 11.72L10.883 16.549L9.652 13.948L19.826 9.119L21.057 11.72Z" fill="currentColor"/>
