...
const c = {
  ...
  faq: {
    ...
    items: {
      "pt-BR": [
        { q: "O TalkToStellar é uma conta internacional?", a: "Não, somos uma plataforma de inteligência financeira conversacional e roteamento de remessas. Nós otimizamos o seu dinheiro para que você converta e liquide valores com taxas drasticamente menores, permitindo o envio para carteiras digitais ou para as contas globais que você já utiliza." },
        { q: "O que é o TalkToStellar?", a: "O TalkToStellar é um motor conversacional de inteligência financeira e roteamento de liquidação instantânea que permite converter seu patrimônio para o exterior com segurança, usando a IA em mensageiros como o WhatsApp e a agilidade da rede Stellar." },
        { q: "Como funciona a conversão?", a: "Você diz o quanto quer converter e nosso Algoritmo de Roteamento encontra a rota mais barata no mercado. Você paga via Pix e o valor correspondente cai na sua conta internacional na mesma hora através da nossa funcionalidade de Entrega Universal com Same-Name Payout." },
      ...
      en: [
        { q: "Is TalkToStellar an international account?", a: "No, we are a conversational financial intelligence and remittance routing platform. We optimize your money so you can convert and settle amounts at drastically lower fees, enabling sending to digital wallets or the global accounts you already use." },
        { q: "What is TalkToStellar?", a: "TalkToStellar is a conversational financial intelligence engine and instant settlement routing that allows you to securely convert your assets abroad, using AI in messengers like WhatsApp and the agility of the Stellar network." },
        { q: "How does conversion work?", a: "You tell us how much you want to convert and our Routing Algorithm finds the cheapest route in the market. You pay via Pix and the corresponding amount lands in your international account immediately through our Universal Delivery with Same-Name Payout." },
  ...
  cta: {
    ...
    subtitle: {
      "pt-BR": "Inicie sua primeira conversão agora mesmo. Use o Pix para abastecer suas contas internacionais pagando uma fração do custo tradicional. Rápido, seguro e direto no seu aplicativo favorito.",
      en: "Start your first conversion right now. Use Pix to fund your international accounts paying a fraction of the traditional cost. Fast, secure and straight from your favorite app.",
    },
