...
async function main(): Promise<void> {
  ...
  if (network === 'testnet' && matches.has('EURC') && !matches.get('EURC')?.issuer) {
    warnings.push('EURC testnet vault was found, but no classic Stellar issuer could be inferred from vault metadata. Set EURC_ISSUER_TESTNET manually.');
  }
