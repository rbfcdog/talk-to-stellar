...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    message: [
      "Posso ajudar com:",
      "1. Contatos: listar, salvar e escolher quem recebe. Se você quiser pagar alguém, eu também tento achar o contato certo primeiro. Ex.: 'quero ver meus contatos' ou 'adicionar Ana com email'.",
      "2. Enviar dinheiro: mando para um contato salvo e já abro o caminho mais seguro da operação, sem precisar montar a rota na mão. Ex.: 'enviar 50 dólares para Ana' ou 'mandar 10 reais para Carlos'.",
      "3. PIX: trazer dinheiro, retirar para seu PIX ou pagar um contato depois do PIX. Ex.: 'colocar 100 reais via PIX', 'sacar 80 reais para meu PIX' ou 'pagar Ana depois do PIX'.",
      "4. Saldo e conta: vejo o que está disponível e mostro a situação da conta, incluindo o que dá para usar agora. Ex.: 'ver saldo' ou 'qual meu saldo em US$'.",
      "5. Conversão: troco entre R$, US$, CETES e as moedas configuradas. Ex.: 'converter 200 reais para cetes', 'trocar dólares por reais' ou 'simular 500 reais para US$'.",
      "6. Link de pagamento: crio um link para cobrar ou receber sem escolher contato antes. Ex.: 'criar link de pagamento de 50 dólares' ou 'fazer um link para receber 100 reais'.",
      "7. Rendimentos / Aplicações: mostrar opções, posição atual e retirada quando você quiser mexer no rendimento. Ex.: 'ver rendimentos', 'aplicar 200 dólares' ou 'quanto tenho aplicado hoje'.",
      "8. Melhor rota: comparo caminho, taxa e economia antes de confirmar, para você decidir com mais clareza. Ex.: 'qual a melhor rota para enviar 300 reais?' ou 'qual o jeito mais barato?'.",
      "9. Histórico, comprovantes e apelidos: mostro pagamentos, comprovantes e apelidos salvos, para você achar operações antigas rápido. Ex.: 'ver histórico' ou 'buscar pagamento de setembro'.",
      "10. PIN e entrada com biometria: ajudo a entrar de novo ou a redefinir o acesso com segurança. Ex.: 'esqueci meu PIN', 'entrar com biometria' ou 'trocar o PIN'.",
      "",
      "Se você me der valor, destinatário e o que quer fazer, eu já sigo direto para a tela certa.",
      "",
      "Exemplos:",
      ...
      "- \"ver histórico\"",
      "",
      "Diga o que quer fazer em uma frase curta e eu abro a tela certa para você.",
    ].join("\n"),
  });
}
