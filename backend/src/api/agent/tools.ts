...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    commands,
    message: [
      "Guia rápido: saldo, PIX, converter, aplicação e ciclo completo.",
      "Você pode ver R$, US$, CETES e moedas configuradas; mandar ou receber via PIX; converter ativos; revisar uma aplicação; ou sair para meu PIX.",
      "",
      "Exemplos prontos:",
