...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    commands,
    message: [
      "👋 Olá! Sou o TalkToStellar, seu assistente financeiro inteligente. Posso ajudar com várias operações — abaixo está tudo o que você pode pedir:",
      "",
      "📇 1. Contatos",
      "   Gerencie suas pessoas de confiança. Posso listar, adicionar ou buscar um contato salvo para enviar dinheiro depois. Se você mencionar um nome, eu procuro automaticamente. Ex.: 'ver contatos', 'adicionar Ana como contato'.",
      "",
      "💸 2. Enviar dinheiro",
      "   Mando valores para qualquer contato salvo. Primeiro eu confirmo o destinatário, mostro o custo total e só então peço sua confirmação com PIN. Tudo transparente. Ex.: 'enviar 50 dólares para Ana', 'mandar 300 reais para Carlos'.",
      "",
      "🏦 3. PIX (entrada e saída)",
      "   Traga reais para sua conta digital ou retire quando precisar. O PIX cai na hora e o saldo aparece automaticamente. Ex.: 'colocar 100 reais via PIX', 'sacar 80 reais para meu PIX', 'pagar Ana via PIX'.",
      "",
      "💰 4. Saldo e conta",
      "   Veja o quanto você tem em cada moeda (US$, R$, CETES, XLM) e o status da sua conta. Ex.: 'ver saldo', 'quanto tenho em dólares', 'meu saldo total'.",
      "",
      "🔄 5. Conversão entre moedas",
      "   Converta entre reais, dólares, euros e as moedas disponíveis. Eu comparo rotas em tempo real para encontrar a mais barata antes de você confirmar. Ex.: 'converter 200 reais para dólares', 'trocar 50 USDC por CETES', 'simular 500 reais para US$'.",
      "",
      "🔗 6. Link de pagamento",
      "   Crie um link para cobrar alguém sem precisar de contato prévio. A pessoa abre, paga com PIX e pronto. Ex.: 'criar link de 50 dólares', 'fazer link para receber 100 reais'.",
      "",
      "📈 7. Rendimentos / Aplicações",
      "   Veja opções de rendimento, seu saldo aplicado, taxas atuais e simulação de evolução. Pode aplicar ou retirar quando quiser. Ex.: 'ver rendimentos', 'aplicar 200 dólares', 'quanto tenho aplicado hoje', 'qual a taxa atual'.",
      "",
      "🧭 8. Melhor rota",
      "   Antes de qualquer operação, eu comparo caminhos disponíveis, taxas e economia estimada. Você vê o comparativo antes de decidir. Ex.: 'qual a melhor rota para 300 reais?', 'quanto vou economizar?'.",
      "",
      "📋 9. Histórico e comprovantes",
      "   Acho operações antigas, comprovantes e apelidos salvos rapidamente. Ex.: 'ver histórico', 'mostrar comprovante do mês passado', 'pagamentos de setembro'.",
      "",
      "🔐 10. PIN, segurança e entrada",
      "   Ajudo com acesso à conta, redefinição de PIN e configuração de biometria (Passkey). Ex.: 'esqueci meu PIN', 'entrar com biometria', 'trocar o PIN', 'quero criar conta'.",
      "",
      "🎯 Como funciona:",
      "Você me diz em uma frase curta o que quer (valor, destinatário se houver, e ação). Eu preparo a operação, mostro taxas e custo total, e só peço seu PIN no final para confirmar. Sem surpresas.",
      "",
      "📌 Exemplos práticos:",
      "- \"enviar 10 dólares para Ana da forma mais otimizada\"",
      "- \"converter 200 reais para dólar americano\"",
      "- \"colocar 100 reais na conta via PIX\"",
      "- \"sacar 50 reais para minha conta por PIX\"",
      "- \"ver meus rendimentos e aplicações\"",
      "- \"criar link de pagamento de 50 dólares\"",
      "- \"ver histórico de setembro\"",
      "- \"simular 500 reais para dólar\"",
      "",
