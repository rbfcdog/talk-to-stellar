...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    message: [
      "Posso ajudar com:",
      "1. Saldo e conta",
      "2. PIX: trazer dinheiro, retirar para seu PIX ou pagar contato",
      "3. Converter R$, US$, CETES e moedas configuradas",
      "4. Enviar dinheiro para contato ou por link",
      "5. Aplicações: nova aplicação, posição atual ou retirada",
      "6. ciclo completo: entrar por PIX, aplicar e sair para meu PIX",
      "7. Melhor rota, cotação, taxas e economia",
      "8. Histórico, comprovantes, apelidos, contatos e PIN",
      "",
      "Exemplos:",
      ...
      "- \"ver histórico\"",
      "",
      "Diga seu objetivo em uma frase que eu abro a tela certa.",
    ].join("\n"),
  });
}
