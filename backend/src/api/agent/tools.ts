...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    message: [
      "Posso ajudar com:",
      "1. Contatos: listar, salvar e escolher quem recebe. Se quiser, também encontro o contato certo para pagar.",
      "2. Enviar dinheiro: mando para um contato salvo e já abro o caminho mais seguro da operação.",
      "3. PIX: trazer dinheiro, retirar para seu PIX ou pagar um contato depois do PIX.",
      "4. Saldo e conta: vejo o que está disponível e mostro a situação da conta.",
      "5. Conversão: troco entre R$, US$, CETES e as moedas configuradas.",
      "6. Link de pagamento: crio um link para cobrar ou receber sem escolher contato antes.",
      "7. Rendimentos / Aplicações: mostrar opções, posição atual e retirada quando você quiser mexer no rendimento.",
      "8. Melhor rota: comparo caminho, taxa e economia antes de confirmar.",
      "9. Histórico, comprovantes e apelidos: mostro pagamentos, comprovantes e apelidos salvos.",
      "10. PIN e entrada com biometria: ajudo a entrar de novo ou a redefinir o acesso com segurança.",
      "",
      "Exemplos:",
