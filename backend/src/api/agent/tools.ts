...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    message: [
      "Posso ajudar com:",
      "1. Contatos: listar, salvar e escolher quem recebe. Ex.: 'quero ver meus contatos' ou 'adicionar Ana com email'.",
      "2. Enviar dinheiro: mando para um contato salvo e já abro o caminho mais seguro da operação. Ex.: 'enviar 50 dólares para Ana'.",
      "3. PIX: trazer dinheiro, retirar para seu PIX ou pagar um contato depois do PIX. Ex.: 'colocar 100 reais via PIX' ou 'sacar 80 reais para meu PIX'.",
      "4. Saldo e conta: vejo o que está disponível e mostro a situação da conta. Ex.: 'ver saldo' ou 'qual meu saldo em US$'.",
      "5. Conversão: troco entre R$, US$, CETES e as moedas configuradas. Ex.: 'converter 200 reais para cetes'.",
      "6. Link de pagamento: crio um link para cobrar ou receber sem escolher contato antes. Ex.: 'criar link de pagamento de 50 dólares'.",
      "7. Rendimentos / Aplicações: mostrar opções, posição atual e retirada quando você quiser mexer no rendimento. Ex.: 'ver rendimentos' ou 'aplicar 200 dólares'.",
      "8. Melhor rota: comparo caminho, taxa e economia antes de confirmar. Ex.: 'qual a melhor rota para enviar 300 reais?'.",
      "9. Histórico, comprovantes e apelidos: mostro pagamentos, comprovantes e apelidos salvos. Ex.: 'ver histórico' ou 'buscar pagamento de setembro'.",
      "10. PIN e entrada com biometria: ajudo a entrar de novo ou a redefinir o acesso com segurança. Ex.: 'esqueci meu PIN'.",
      "",
      "Exemplos:",
