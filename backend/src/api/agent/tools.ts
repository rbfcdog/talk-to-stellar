...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    message: [
      "Posso ajudar com:",
      "1. Contatos: listar, salvar e pagar destinatários salvos",
      "2. Enviar dinheiro para contato salvo",
      "3. PIX: trazer dinheiro, retirar para seu PIX ou pagar contato",
      "4. Saldo e conta",
      "5. Converter R$, US$, CETES e moedas configuradas",
      "6. Link de pagamento para cobrar ou receber",
      "7. Rendimentos: aplicar, ver posição atual ou retirar",
