...
function executeGetIntentHelp(): string {
  ...
  return JSON.stringify({
    ...
    message: [
      ...
      "4. Enviar dinheiro para contato salvo",
      "5. Link de pagamento para cobrar ou receber",
      "6. Aplicações: nova aplicação, posição atual ou retirada",
      "7. ciclo completo: PIX, aplicação e sair para meu PIX",
      "8. Melhor rota, cotação, taxas e economia",
      "9. Histórico, comprovantes e apelidos",
      "10. Contatos, PIN e entrada com biometria",
      "",
      "Exemplos:",
